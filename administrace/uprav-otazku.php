...
<head>
    ...
    <title>TailStory - upravit otázku</title>
...
<?php
        ...
        if(isset($_SESSION['username'])){
            ...
            <?php
        $zmen = $_GET["ID"];
        $upravOtazku = $obsah->vrat($zmen, "otazky");
        ?>
            <div class="container admin otazky">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 text-center">
            <form method="POST" action="zapisupravu-otazka.php?ID=<?php echo $zmen;?>" id="vlozit">
                <h1>Upravit otázku</h1>
                <p><label>Autor:</label><br><input type="text" name="autor" value="<?php echo $upravOtazku->autor; ?>"></p>
                <p><label>Otázka:</label><br><textarea rows="3" cols="50" name="otazka" required><?php echo $upravOtazku->otazka;?></textarea></p>
                <p><label>Odpověď:</label><br><textarea rows="3" cols="50" name="odpoved" required><?php echo $upravOtazku->odpoved;?></textarea></p>
                <p><input type="submit" name="upravOtazku" value="Upravit otázku"></p>
            </form>
            </div>
                </div>
            </div>
