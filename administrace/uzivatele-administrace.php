...
<head>
  ...
  <title>TailStory - uživatelé</title>
    ...
    if ($_SESSION["opravneni"] == "administrator") {
     ...
     <div class="container p-0 admin">
         <div class="row">
             ...
             <a href="new-uzivatel.php"><i class="far fa-plus-square" style="color: #C71585; font-size: 40px;"></i></a>
             </div>
             <div class="col-lg-12 col-md-12 col-sm-12">
                 <h2 class="nadpis-administrace">Výpis zaregistrovaných uživatelů</h2>
     ...
     <?php
     $vypisUzivatelu = $obsah->vratTabulku("uzivatele");
     foreach ($vypisUzivatelu as $uzivatel) {
         $ID = $uzivatel->ID;
         ...
         ?>
             <tr>
                 ...
                 <td><a href=uprav-uzivatele.php?ID=<?php echo $ID; ?>><img src='../img/edit.jpg' class='uprava' width="30" alt="Upravit"></a>
                 </td>
                 <td><?php if($ID != 1 && $_SESSION["username"] != $jmeno) { ?><a href=smaz.php?ID=<?php echo $ID."&tabulka=uzivatele"; ?>
                        onclick="return confirm('Chcete opravdu smazat uživatele?')"><img src='../img/delete.png'
                                                                                        class='uprava' width="30" alt="Smazat"></a><?php } ?>
                 </td>
             </tr>
         <?php
     }
