...
<?php
 if(isset($_SESSION['username'])) {
    if ($_SESSION["opravneni"] == "administrator") {
     ...
     <div class="container p-0 admin">
         <div class="row">
             <div class="col-lg-12 col-md-12 col-sm-12">
                 <h2 class="nadpis-administrace">Výpis položených otázek</h2>
     ...
     <?php
     $vypisOtazek = $obsah->vratOtazky();
     foreach ($vypisOtazek as $otazka) {
         $ID = $otazka->ID;
         $datum = $otazka->datum;
         $datum = date("d. m. Y", strtotime($datum));
         $autor = $otazka->autor;
         $odpoved = $otazka->odpoved;
         $otazka = $otazka->otazka;
         ?>
             <tr <?php if ($odpoved == "") echo 'class=novaOtazka'; ?>>
                 <td><?php echo $datum; ?></td>
                 <td><?php echo $otazka; ?></td>
                 <td><?php echo $odpoved; ?></td>
                 <td><a href=uprav-otazku.php?ID=<?php echo $ID; ?>><img src='../img/edit.jpg' class='uprava' width="30" alt="Upravit"></a>
                 </td>
                 <td><a href=smaz.php?ID=<?php echo $ID."&tabulka=otazky"; ?>
                        onclick="return confirm('Chcete opravdu smazat otázku?')"><img src='../img/delete.png'
     ...
     ?>
                 ...
                 <div class="mt-5"><div class="legendaOtazky d-table-cell my-auto"></div><p class="d-table-cell align-middle pl-2"> - nezodpovězená otázka</p></div>
             </div>
         </div>
     </div>
<?php
