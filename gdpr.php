...
<body class="d-flex flex-column">
  ...
  <section class="oazylu mb-5 gdpr">
      <div class="pl-5 pr-5 pb-5"><h1 class="display-4">Souhlas se zpracováním osobních údajů</h1></div>
      <div class="container">
      <?php
      $vypisGDPR = $obsah->vratElementy("ostatni", "gdpr");
      foreach($vypisGDPR as $GDPR) {
          $obsahElementu = $GDPR->obsah;
          ?>
          <div class="row">
              <div class="col-md-12">
