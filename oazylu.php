...
<body class="d-flex flex-column">
  ...
  <div class="oazylu mb-5">
      <div class="pl-5 pr-5 pb-5"><h1 class="display-4">O azylu</h1></div>
      <p class="lead podkategorie" style="padding-left: 48px;"><a href="otazkyodpovedi.php">Otázky a odpovědi</a></p>
      <div class="container">
      <?php
      $vypisOazylu = $obsah->vratElementy("oazylu", "oazylu");
