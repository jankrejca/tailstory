...
<head>
    ...
    <title>TailStory - nové očkování</title>
        ...
        <div class="container admin otazky">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 text-center">
                    <form method="POST">
                        <h1>Přidat nové očkování</h1>
                        <p><label>Pes (ID):</label><br>
                        <select name="pes">
                            <?php $psi = $obsah->vratObyvateleAdmin();
                            foreach ($psi as $pes) {
                                echo "<option value='".$pes->ID."'>".$pes->jmeno." (".$pes->ID.")</option>";
                            } ?>
                        </select>
                        </p>
                        <p><label>Datum a čas:</label><br><input type="datetime-local" name="datum" required></p>
                        <p><label>Název:</label><br><input type="text" name="nazev" required></p>
                        <p><input type="submit" name="vlozOckovani" value="Vložit očkování"></p>
                    </form>
                </div>
            </div>
        </div>
