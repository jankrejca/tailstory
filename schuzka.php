...
<head>
  ...
  <title>TailStory - domluvit si schůzku</title>
...
<body class="d-flex flex-column">
  ...
  <div class="pl-5 pr-5 pb-5"><h1 class="display-4">Domluvit si schůzku</h1></div>
      ...
      <div class="container-fluid schuzka">
          <div class="row">
              <div class="col-lg-12 col-sm-12 text-center">
                  ...
                  <label>Datum schůzky:</label><br><input type="date" name="datum" required><br>
                  <label>Čas schůzky:</label><br><input type="time" name="cas"/><br>
                  <label>Poznámka:</label><br><textarea name="poznamka" placeholder="Poznámka"></textarea><br>
                  <input type="hidden" name="pes" value="<?php echo $_GET['ID']; ?>">
                  <label>odesláním souhlasíte se <a href="gdpr.php">zpracováním osobních údajů</a></label><br><input type="submit" name="vlozSchuzku" value="Odeslat" class="btn-card">
              </form>
          </div>
          </div>
          </div>
