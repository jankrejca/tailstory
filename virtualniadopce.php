...
<head>
  ...
  <title>TailStory - virtuální adopce</title>
...
<body class="d-flex flex-column">
  ...
  <div class="oazylu mb-5">
      <div class="pl-5 pr-5 pb-5"><h1 class="display-4">Virtuální adopce</h1></div>
      <div class="container">
      <?php
      $vypisVirtualniAdopce = $obsah->vratElementy("virtualniadopce", "virtualniadopce");
      foreach($vypisVirtualniAdopce as $virtualniAdopce) {
          $obsahElementu = $virtualniAdopce->obsah;
          ?>
          <div class="row">
